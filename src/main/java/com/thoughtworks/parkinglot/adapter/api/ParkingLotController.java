...
public class ParkingLotController {
    ...
    @ResponseStatus(OK)
    public ParkingLotIdResponse listParkingLot(@RequestParam(required = false)
                                                   final String parkingManagerName) {
        return parkingLotServiceFacade.listsParkingLotWithSpace(parkingManagerName);
    }
